...
# problem:: Error in h(simpleError(msg, call)) : 
  # error in evaluating the argument 'y' in selecting a method for function 'extract': argument "species_df" is missing, with no default

fire_df_2001 <- lapply(month_list_nonleep, burn_data, species_df) %>% 
  bind_rows()
